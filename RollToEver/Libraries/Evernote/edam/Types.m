...
@dynamic shareDate;
@dynamic taskDate;
@dynamic taskCompleteDate;
@dynamic taskDueDate;
@dynamic placeName;
@dynamic contentClass;
@dynamic applicationData;
#endif
  ...
  if (__sharedNotebookIds_isset) {
    if (__sharedNotebookIds != nil) {
      [outProtocol writeFieldBeginWithName: @"sharedNotebookIds" type: TType_LIST fieldID: 13];
      {
        ...
        int i40;
        for (i40 = 0; i40 < [__sharedNotebookIds count]; i40++)
        {
          [outProtocol writeI64: [[__sharedNotebookIds objectAtIndex: i40] longLongValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
